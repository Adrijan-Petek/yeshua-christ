...
export default function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-gradient-to-br from-stone-50 via-amber-50 to-stone-100 dark:from-black dark:via-stone-950 dark:to-black px-4">
      <div className="text-center space-y-5 max-w-sm">
        ...
        <div className="space-y-2">
          <h1 className="text-xl sm:text-2xl font-bold text-stone-800 dark:text-amber-300">
            Yeshua-Christ
          </h1>
        ...
        <div>
          <div className="w-7 h-7 border-2 border-stone-400 dark:border-amber-400 border-t-transparent rounded-full animate-spin mx-auto"></div>
        </div>
      </div>
    </div>
  );
